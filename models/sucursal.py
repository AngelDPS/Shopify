...
class _MsucursalAddress(BaseModel):
    ...
    provinceCode: constr(to_upper=True) | None = Field(
        None, title="Código de provincia",
        description="Código ISO 3166-2 de la provincia del país",
        min_length=4, max_length=5)
    city: str | None = Field(
        None,
        title="Ciudad",
        description="Ciudad, poblado o distrito en el que "
        "se ubica la sucursal.")
    address1: str | None = Field(None, title="Línea 1 de dirección",
                                 description="Primera línea para especificar "
                                 "la dirección de la sucursal.", max_lengt=40)
    address2: str | None = Field(None, title="Línea 2 de dirección",
                                 description="Segunda línea para especificar "
                                 "la dirección de la sucursal.", max_lengt=40)
