...
class MSEOInput(BaseModel):
    ...
    """
    description: str | None = Field(None, title="Descripción", description="Descripción a mostrar para el motor de búsqueda.")
    title: str | None = Field(None, title="Título", description="Titulo para mostrar en el motor de búsqueda.")


class MimageInput(BaseModel):
    """Datos de la imagen a asociar con el objeto.
    """
    altText: str | None = Field(None, title="Texto alternativo", description="Palabra o frase para mostrar que describa la naturaleza o contenido de la imagen.")
    id: str | None = Field(None)
    src: str | None = Field(None, title="Origen", description="El URL de la imagen.")
